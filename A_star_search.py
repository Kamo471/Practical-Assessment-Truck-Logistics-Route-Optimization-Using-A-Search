...
# Completed graph based on the weights provided
graph = {
...
# 3. Heuristic to goal (Coligny) based on Traffic per city
heuristic = {
    "Disaneng": 70,
    "Mahikeng": 50,
    "Mmabatho": 55,
...
path, visited_order, total_cost = astar(graph, weights, heuristic, start_node, goal_node)
